...
import { locale as menuPortuguese } from 'app/menu/i18n/pt-br';
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this._translateService.addLangs(['en', 'fr', 'de', 'pt-br']);
  ...
  ngOnInit(): void {
    ...
    this._coreConfigService.config.pipe(takeUntil(this._unsubscribeAll)).subscribe(config => {
      ...
      const appLanguage = this.coreConfig.app.appLanguage || 'pt-br';
